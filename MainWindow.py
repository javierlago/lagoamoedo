...
"}")
        ...
        self.gridLayout_3.addWidget(self.txtDni, 0, 5, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.tltDate, 0, 14, 1, 2)
        self.txtDate = QtWidgets.QLineEdit(parent=self.boxInfo)
        self.txtDate.setObjectName("txtDate")
        self.gridLayout_3.addWidget(self.txtDate, 0, 16, 1, 1)
...
"")
        ...
        self.gridLayout_3.addWidget(self.btnCalendar, 0, 17, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.txtDni_2, 1, 1, 1, 6)
        ...
        self.gridLayout_3.addWidget(self.lblName, 1, 8, 1, 1)
        self.txtNombre = QtWidgets.QLineEdit(parent=self.boxInfo)
        self.txtNombre.setObjectName("txtNombre")
        self.gridLayout_3.addWidget(self.txtNombre, 1, 9, 1, 9)
        ...
        self.gridLayout_3.addWidget(self.txtDireccion, 2, 1, 1, 6)
        ...
        self.gridLayout_3.addWidget(self.lblProvincia, 2, 8, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lblLocalidad, 2, 14, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.cmbLocalidad, 2, 15, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.lblMovil, 3, 0, 1, 1)
        self.txtMovil = QtWidgets.QLineEdit(parent=self.boxInfo)
        self.txtMovil.setObjectName("txtMovil")
        self.gridLayout_3.addWidget(self.txtMovil, 3, 1, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.lblSalario, 3, 4, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.txtSalario, 3, 5, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.lblTxt, 3, 7, 1, 1)
        self.label = QtWidgets.QLabel(parent=self.boxInfo)
        self.label.setObjectName("label")
        self.gridLayout_3.addWidget(self.label, 3, 8, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.rbtTodos, 3, 11, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.rbtAlta, 3, 12, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnBajaDriver, 5, 9, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnaltaDriver, 5, 6, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnModifDriver, 5, 12, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lblCodDB, 0, 1, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.lblCheckDNI, 0, 7, 1, 1)
