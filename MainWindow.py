...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icono/3986726-man-taxi-transport-icon_112967.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("img/CancelIco.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.lblTxt.setText("")
        self.lblTxt.setPixmap(QtGui.QPixmap("../../.designer/backup/img/euro.png"))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icono/salir.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.Salir.setIcon(icon2)
        self.Salir.setObjectName("Salir")
        self.btnLimpiar = QtGui.QAction(parent=MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icono/pincel.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
