...
"}")
        ...
        self.lblCodigo.setStyleSheet("font: 75 10pt \"Alef\";")
        ...
        self.lblCodDB.setStyleSheet("background-color: rgb(247, 181, 0);bold;border: 1px solid black")
        ...
        self.tltDate.setMinimumSize(QtCore.QSize(100, 13))
        self.tltDate.setMaximumSize(QtCore.QSize(100, 13))
