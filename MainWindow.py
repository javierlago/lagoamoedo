...
"background-color: rgb(247, 181, 0);")
        ...
        self.tabDriver2.setStyleSheet("QHeaderView::section { background-color: rgb(247, 181, 0); border-radius: 1px; color: black;font-weight: bold;border: 1px solid black;}")
        ...
        self.tabDriver2.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.DragOnly)
