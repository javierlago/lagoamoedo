...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/CancelIco.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icono/salir.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.Salir.setIcon(icon1)
        self.Salir.setObjectName("Salir")
        self.btnLimpiar = QtGui.QAction(parent=MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("img/pincel.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
